...
<%-- 
    Document   : patChangeInfo
    Created on : Nov 10, 2022, 12:04:30 PM
...
<html>
    ...
    <body>
        ...
        <div class="testbox">
            <h1>Patient Info Change</h1>
            
            <form name="dataForm" action="patInfoChangeServlet" class="form-class">
            <hr>
